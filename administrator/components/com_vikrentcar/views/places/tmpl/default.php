...
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="table table-striped">
	...
	for ($i = 0, $n = count($rows); $i < $n; $i++) {
		...
		<tr class="row<?php echo $k; ?>">
			...
			<td class="center">
				<a href="index.php?option=com_vikrentcar&amp;task=sortlocation&amp;cid[]=<?php echo $row['id']; ?>&amp;mode=up"><i class="fa fa-arrow-up vrc-icn-img"></i></a> 
				<a href="index.php?option=com_vikrentcar&amp;task=sortlocation&amp;cid[]=<?php echo $row['id']; ?>&amp;mode=down"><i class="fa fa-arrow-down vrc-icn-img"></i></a>
			</td>
		</tr>
		<?php
		$k = 1 - $k;
