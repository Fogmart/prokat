...
$fprice = "<div class=\"vrc-fares-tabs\"><div class=\"dailyprices\"><a href=\"index.php?option=com_vikrentcar&task=tariffs&cid[]=".$idcar."\">".JText::_('VRCDAILYFARES')."</a></div><div class=\"hourschargesactive\">".JText::_('VRCHOURSCHARGES')."</div><div class=\"hourlyprices\"><a href=\"index.php?option=com_vikrentcar&task=tariffshours&cid[]=".$idcar."\">".JText::_('VRCHOURLYFARES')."</a></div></div>\n";
if (empty($prices)) {
	...
	$fprice .= "<span class=\"vrc-ratestable-lbl\">".JText::_('VRCHOURLYCHARGES').": </span><table>\n";
