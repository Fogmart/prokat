					...
					<div class="vrc-editbooking-tbl">
						...
						<div class="vrc-bookingdet-summary-car vrc-editbooking-summary-car">
							<div class="vrc-editbooking-summary-car-head">
								<div class="vrc-bookingdet-summary-carnum"><i class="fa fa-car"></i> <?php echo $car['name']; ?></div>
							<?php
							if ($switching) {
								?>
								...
								foreach ($optionals as $k => $o) {
									...
									<div class="vrc-editbooking-car-option">
										...
										<div class="vrc-editbooking-car-option-check">
											<?php echo (intval($o['hmany'])==1 ? "<input type=\"number\" name=\"optid".$o['id']."\" id=\"optid".$o['id']."\" value=\"".$oval."\" min=\"0\" size=\"5\" style=\"width: 50px !important;\"/>" : "<input type=\"checkbox\" name=\"optid".$o['id']."\" id=\"optid".$o['id']."\" value=\"".$optquancheckb."\"".$oval."/>"); ?>
										</div>
									</div>
									<?php
								}
								...
								foreach ($cur_extra_costs as $eck => $ecv) {
									...
									<div class="vrc-editbooking-car-extracost">
										<div class="vrc-ebusy-extracosts-cellname">
											<input type="text" name="extracn[]" value="<?php echo addslashes($ecv['name']); ?>" placeholder="<?php echo addslashes(JText::_('VRPEDITBUSYEXTRACNAME')); ?>" size="25" />
										</div>
										<div class="vrc-ebusy-extracosts-cellcost">
											<span class="vrc-ebusy-extracosts-currency"><?php echo $currencysymb; ?></span> 
											<input type="number" step="any" name="extracc[]" value="<?php echo addslashes($ecv['cost']); ?>" size="5" />
										</div>
