...
<div class="table-responsive">
	...
	for ($i = 0, $n = count($rows); $i < $n; $i++) {
		...
		<tr class="row<?php echo $kk; ?>">
			...
			<td><a href="index.php?option=com_vikrentcar&amp;task=editcustomer&amp;cid[]=<?php echo $row['id']; ?>"><?php echo $row['id']; ?></a></td>
			<td><a href="index.php?option=com_vikrentcar&amp;task=editcustomer&amp;cid[]=<?php echo $row['id']; ?>"><?php echo $row['first_name']; ?></a></td>
