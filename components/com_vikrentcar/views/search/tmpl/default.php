...
<div class="vrcstepsbarcont">
	<ol class="vrc-stepbar" data-vrcsteps="4">
		...
		<li class="vrc-step vrc-step-next"><span><?php echo JText::_('VRSTEPOPTIONS2'); ?></span></li>
...
<div class="vrc-itinerary-summary">
	...
	?>
		<div class="vrc-itinerary-dropoff-date">
			...
			<span class="vrc-itinerary-duration"><?php echo $days . ' ' . strtolower(JText::_(($days > 1 ? 'VRDAYS' : 'VRDAY'))); ?></span>
		</div>
	</div>
</div>
<?php
				...
				<div class="vrc-car-lastblock">
						<div class="vrc-car-price">
							<div class="vrcsrowpricediv<?php echo $has_promotion === true ? ' vrc-promotion-price' : ''; ?>">
								...
								<span class="vrc_price"><?php echo VikRentCar::numberFormat($car_cost); ?></span> <span class="vrc_currency"><?php echo $currencysymb; ?></span>
							</div>
							<?php
