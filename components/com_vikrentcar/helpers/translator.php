...
class VikRentCarTranslator {
	...
	public function getIniFiles() {
		...
		return array(
			'com_vikrentcar_front' => array('path' => JPATH_SITE.DS.'language'.DS.'en-GB'.DS.'en-GB.com_vikrentcar.ini'),
			'com_vikrentcar_admin' => array('path' => JPATH_ADMINISTRATOR.DS.'language'.DS.'en-GB'.DS.'en-GB.com_vikrentcar.ini'),
			'com_vikrentcar_admin_sys' => array('path' => JPATH_ADMINISTRATOR.DS.'language'.DS.'en-GB'.DS.'en-GB.com_vikrentcar.sys.ini'),
			'mod_vikrentcar_search' => array('path' => JPATH_SITE.DS.'language'.DS.'en-GB'.DS.'en-GB.mod_vikrentcar_search.ini')
		);
	}
