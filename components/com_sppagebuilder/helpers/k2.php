...
$k2Unilities = JPATH_SITE.DS.'components'.DS.'com_k2'.DS.'helpers'.DS.'utilities.php';
...
abstract class SppagebuilderHelperK2{
	...
	public static function getCategories($parent_id = 0, $include_subcategories = true, $child = false) {
