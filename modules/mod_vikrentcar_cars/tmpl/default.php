			...
			<div class="vrc-modcars-item <?php echo ($get_cars_layout) ? '' : 'vrc-modcars-grid-item'; ?>" style="<?php echo ($get_cars_layout) ? '' : 'width: '.$calc_item_width.'%;' ; ?>" data-groups='["<?php echo $c['catname']; ?>"]'>
				...
				<figure class="vrcmodcarsgridcont-item">
					...
					<div class="vrcmodcarsgrid-item-btm">
							...
							if ($showcatname) {
							?>
							<div class="vrcmodcarsgrid-item_cat"><?php echo JText::_('VRCMODCARCATNAME'); ?> - <?php echo $c['catname']; ?></div>
							<?php
							}
							?>
					...
					<figcaption class="vrcmodcarsgrid-item_title"><?php echo $c['name']; ?></figcaption>
						...
						<div class="vrcmodcarsgrid-box-cost">
							...
							<span class="vrcmodcarsgridcarcost"><span class="vrc_price"><?php echo modvikrentcar_carsHelper::numberFormat($c['cost']); ?></span> <span class="vrc_currency"><?php echo $currencysymb; ?></span>
							/ <span class="vrc_currency"><?php echo JText::_('VRCMODCARSTARTFROMS'); ?></span>
							</span>
						</div>
						<?php
						}
