...
class SppagebuilderAddonTestimonialpro extends SppagebuilderAddons {
	...
	public function render() {
		...
		if($arrows) {
			$output	.= '<div class="owl-buttons"><a href="#sppb-testimonial-pro-'. $this->addon->id .'" class="left sppb-carousel-control" data-slide="prev"><i class="fa fa-angle-left"></i></a>';
			$output	.= '<a href="#sppb-testimonial-pro-'. $this->addon->id .'" class="right sppb-carousel-control" data-slide="next"><i class="fa fa-angle-right"></i></a></div>';
		}
