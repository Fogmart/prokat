			...
			'general' => array(
				...
				'sp_carousel_item'=>array(
					...
					'attr'=>  array(
						...
						'subtitle'=>array(
							'type'=>'text',
							'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_CAROUSEL_ITEM_SUBTITLE'),
							'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_CAROUSEL_ITEM_SUBTITLE_DESC'),
							'std'=>'Carousel Item subTitle',
						),
