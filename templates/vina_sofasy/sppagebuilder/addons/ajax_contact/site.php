...
function sp_ajax_contact_addon($atts){
	...
	$class = ($formcaptcha) ? 'col-sm-6' : 'col-sm-4';
	$output .= '<div class="sppb-addon-content">';
	$output .= '<form class="sppb-ajaxt-contact-form row">';

	$output .= '<div class="sppb-form-group '.$class.'">';
	...
	$output .= '<div class="sppb-form-group col-sm-12">';
	...
	$output .= '<div class="col-sm-12"><button type="submit" class="sppb-btn sppb-btn-primary"><i class="fa"></i> '. JText::_('COM_SPPAGEBUILDER_ADDON_AJAX_CONTACT_SEND') .'</button></div>';
