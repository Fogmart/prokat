...
class SppagebuilderAddonCountdown extends SppagebuilderAddons{
	...
	public function render() {
		...
		$countdown_data = array(
			...
			'text_sec' 	  	=> JTEXT::_('HELIX_SECOND'),
			'text_secs' 		=> JTEXT::_('HELIX_SECONDS'),
			'text_min' 	  	=> JTEXT::_('HELIX_MINUTE'),
			'text_mins' 		=> JTEXT::_('HELIX_MINUTES'),
			'text_hour'   	=> JTEXT::_('HELIX_HOUR'),
			'text_hours'   	=> JTEXT::_('HELIX_HOURS'),
