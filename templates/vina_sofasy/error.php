...
//background image
$error_bg 	= JURI::root() . '/templates/' . $this->template . '/images/bg_error.jpg';
$img_error 	= JURI::root() . '/templates/' . $this->template . '/images/404.png"';
			...
			<div>
				<div class="container">
					...
					<?php if($this->error->getCode() == 404) {?>
						<img class="error-code-img" src="<?php echo $img_error; ?>" alt="404">
					<?php } else { ?>
