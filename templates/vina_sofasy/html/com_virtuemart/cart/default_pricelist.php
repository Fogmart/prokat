...
?>
<fieldset class="vm-fieldset-pricelist table-responsive">
<table
	class="cart-summary"
	cellspacing="0"
	cellpadding="0"
	border="0"
	width="100%">
<tr class="vm-cart-title">
	<th class="vm-cart-item-image" ><?php echo vmText::_ ('COM_SPPAGEBUILDER_ADDON_IMAGE_CONTENT_IMAGE') ?></th>
...
<tr style="vertical-align: top" class="sectiontableentry<?php echo $i ?>">
	...
	<td class="vm-cart-item-name" >
		...
		<p class="vm-cart-item-sku" >SKU: <?php  echo $prow->product_sku ?></p>
	</td>
	...
	<td class="vm-cart-item-quantity" ><?php
		...
		<input type="text"
			...
			<button type="submit" class="vmicon vm2-add_quantity_cart fa fa-refresh" name="updatecart.<?php echo $pkey ?>" title="<?php echo  vmText::_ ('COM_VIRTUEMART_CART_UPDATE') ?>" ></button>

			<button type="submit" class="vmicon vm2-remove_from_cart fa fa-trash-o" name="delete.<?php echo $pkey ?>" title="<?php echo vmText::_ ('COM_VIRTUEMART_CART_DELETE') ?>" ></button>
	</td>
	<?php if (VmConfig::get ('show_tax')) { ?>
...
<tr class="sectiontableentry1">
	<td colspan="4" style="text-align: left;"><?php echo vmText::_ ('COM_VIRTUEMART_ORDER_PRINT_PRODUCT_PRICES_TOTAL'); ?></td>
	<?php if (VmConfig::get ('show_tax')) { ?>
