...
<!-- HTML Block -->
<div id="vina-carousel-virtuemart<?php echo $module->id; ?>" class="vina-carousel-virtuemart owl-carousel owl-theme hot-deals <?php echo $classSuffix; ?>">
	<?php
		$col 	= 1;
		$nb 	= 1;
		...
		<div class="product product-i">
			<div class="product-container">
				...
				<div class="vm-product-media-container">
					...
					<div class="image-block banner-static <?php echo ($product->images[1]) ? '' : ''; ?>">
						<a href="<?php echo $pLink; ?>" title="<?php echo $pName; ?>">	
							<div class="pro-image single-image">
								<img class="browseProductImage lazy" src="<?php echo $pImage; ?>" alt="<?php echo $pName; ?>" title="<?php echo $pName; ?>" />
							</div>					
						</a>
					</div>
				</div>
