...
//Coming Soon
if ($this->helix3->getParam('comingsoon_mode') && !$isroot) {
...
<meta name="viewport" content="width=device-width, initial-scale=1">
	...
	$this->helix3->addCSS('bootstrap.min.css, font-awesome.min.css, material-design-iconic-font.min.css') // CSS Files
			->addJS('bootstrap.min.js, main.js, bootstrap-select.min.js, owl.carousel.min.js, jquery.lazy.min.js, vinatab.js, template.js') // JS Files
	...
	<link rel="stylesheet" href="http://prokat.robonetika.ru/css/style.css">
	
	
		<script src="http://prokat.robonetika.ru/js/modernizr.js"></script>
<script src="http://prokat.robonetika.ru/js/main.js"></script>
